" Vim color file
"  Maintainer: leo
" Last Change: 2021/08/27 Fin 22:32.
"     version: 1.0
" Forked from candy
...
" Syntax group
hi Comment      gui=ITALIC guifg=#c0c0d0 guibg=NONE
hi Constant     gui=BOLD guifg=#90d0ff guibg=NONE
hi Error        gui=BOLD guifg=#ffffff guibg=#ff0088
hi Identifier   gui=BOLD guifg=#40f0f0 guibg=NONE
